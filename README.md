...
Prepackaged binaries for windows can be found as releases on github. Make sure to install all of the .ttf font files found in the /fonts/ directory to ensure UI text consistency.
